...
LEARNING_RATE = 5e-3
PATIENCE=10
LOSS_PIC_SAVE_PATH = './longterm_loss_pics'
...
def train_transformer_model(
    ...
    for epoch in range(num_epochs):
        ...
        # 保存当前 epoch 的检查点
        checkpoint_path = os.path.join(checkpoint_dir, f"transformer_{timestamp}_epoch_{epoch+1}.pth")
        torch.save({
            'epoch': epoch + 1,
...
def run_experiment_from_checkpoint(
    ...
    # 获取最新的检查点路径
    if checkpoint_path=='':
        latest_checkpoint = sorted(glob.glob("./longterm_checkpoints/transformer_*.pth"))[-1]
...
if __name__ == "__main__":
    ...
    # main_load_checkpoints_and_test(checkpoint_path='/home/jmyan/jqxx/src/checkpoints/transformer_20250117_110817_epoch_40.pth')